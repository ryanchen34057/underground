            ...
            for (int i=0; i<saveDatas.length;i++) {
                ...
                if (record == null) {
                    ...
                    if (!(saveSlotWordsMap.containsKey(record))) {
                        ...
                        Words levelWords = new Words("Level: " + record.getCurrentLevel(), (int) (Window.scaledGameWidth* 0.023), (int) (rectangle.x + rectangle.getWidth()/2.8), (int) (rectangle.y + (rectangle.getHeight()/1.75)));
